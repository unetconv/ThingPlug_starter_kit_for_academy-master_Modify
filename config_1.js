...
module.exports = {
  ...
  nodeID : '1.2.481.1.100',         	// Device 구분을 위한 LTID, 디바이스 고유 ID 사용
  passCode : '1234',                          	// ThingPlug에 Device등록 시 사용할 Device의 비밀번호
  uKey : 'testtest==',                	// Thingplug로그인 후, `마이페이지`에 있는 사용자 인증키

  containerName:'container',                         	// starter kit에서 생성하고 사용할 container 이름 (임의지정)
